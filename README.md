...
> A product-neutral, stack-neutral starter for agent-readable project context, decisions, plans, and verification evidence.
...
| Area | Current Value |
| --- | --- |
| Purpose | Agent-readable harness starter |
