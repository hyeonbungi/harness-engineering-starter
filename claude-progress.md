...
- [x] `AGENTS.md`를 에이전트 지침의 단일 진실 원천으로 고정하고 `CLAUDE.md`를 `@AGENTS.md` 포인터로 축소
...
- 2026-06-06: `AGENTS.md`를 Codex, Claude Code, 범용 에이전트 지침의 단일 진실 원천으로 정리하고, `CLAUDE.md`는 `@AGENTS.md` 포인터와 최소 Claude 전용 메모만 남겼습니다.
